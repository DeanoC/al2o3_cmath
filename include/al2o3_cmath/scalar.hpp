...
AL2O3_FORCE_INLINE type Pi() { return Math_Pi##postfix(); } \
AL2O3_FORCE_INLINE type PiOver2() { return Math_PiOver2##postfix(); } \
AL2O3_FORCE_INLINE type TwoPi() { return Math_TwoPi##postfix() } \
