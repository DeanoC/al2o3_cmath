...
typedef struct Math_Aabb2F {
	Math_Vec2F minExtent;
	Math_Vec2F maxExtent;
} Math_Aabb2F;

typedef struct Math_Aabb3F {
	Math_Vec3F minExtent;
	Math_Vec3F maxExtent;
} Math_Aabb3F;
...
AL2O3_LINK_OR_INLINE Math_Aabb2F Math_Aabb2FFromCenterAndLength(Math_Vec2F center, Math_Vec2F length) {
	Math_Vec2F halfLength = Math_ScalarMulVec2F(length, 0.5f);
	Math_Aabb2F ret = {
...
AL2O3_LINK_OR_INLINE Math_Aabb2F Math_Aabb2FFromCenterAndHalfLength(Math_Vec2F center, Math_Vec2F halfLength) {
	Math_Aabb2F ret = {
			Math_SubVec2F(center, halfLength),
			Math_AddVec2F(center, halfLength),
	};
...
AL2O3_LINK_OR_INLINE bool Math_IsValidAabb2F(Math_Aabb2F const *aabb) {
	Math_Vec2F diff = Math_SubVec2F(aabb->maxExtent, aabb->minExtent);
	return (Math_DotVec2F(diff, diff) > 0.0f);
}

AL2O3_LINK_OR_INLINE Math_Vec2F Math_CenterAabb2F(Math_Aabb2F const *aabb) {
	Math_Vec2F total = Math_AddVec2F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec2F(total, 0.5f);
}

AL2O3_LINK_OR_INLINE Math_Vec2F Math_HalfLengthAabb2F(Math_Aabb2F const *aabb) {
	Math_Vec2F diff = Math_SubVec2F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec2F(diff, 0.5f);
}
AL2O3_LINK_OR_INLINE void Math_SetCenterAabb2F(Math_Aabb2F *aabb, Math_Vec2F center) {
	Math_Vec2F const oldCenter = Math_CenterAabb2F(aabb);
...
AL2O3_LINK_OR_INLINE void Math_ExpandAabb2F(Math_Aabb2F *aabb, Math_Vec2F by) {
...
AL2O3_LINK_OR_INLINE bool Math_DoesIntersectAabb2F(Math_Aabb2F const *aabb, Math_Aabb2F const *with) {
	Math_Vec2F minI = Math_MaxVec2F(aabb->minExtent, with->minExtent);
	Math_Vec2F maxI = Math_MinVec2F(aabb->maxExtent, with->maxExtent);

	return ((minI.v[0] < maxI.v[0]) && (minI.v[1] < maxI.v[1]));
}
AL2O3_LINK_OR_INLINE bool Math_DoesIntersectPointAabb2F(Math_Aabb2F const *aabb, Math_Vec2F const with) {
	return (
...
AL2O3_LINK_OR_INLINE Math_Aabb3F Math_Aabb3FFromCenterAndLength(Math_Vec3F center, Math_Vec3F length) {
	Math_Vec3F halfLength = Math_ScalarMulVec3F(length, 0.5f);
	Math_Aabb3F ret = {
...
AL2O3_LINK_OR_INLINE Math_Aabb3F Math_Aabb3FFromCenterAndHalfLength(Math_Vec3F center, Math_Vec3F halfLength) {
	Math_Aabb3F ret = {
			Math_SubVec3F(center, halfLength),
			Math_AddVec3F(center, halfLength),
	};
...
AL2O3_LINK_OR_INLINE bool Math_IsValidAabb3F(Math_Aabb3F const *aabb) {
	Math_Vec3F diff = Math_SubVec3F(aabb->maxExtent, aabb->minExtent);
	return (Math_DotVec3F(diff, diff) > 0.0f);
}

AL2O3_LINK_OR_INLINE Math_Vec3F Math_CenterAabb3F(Math_Aabb3F const *aabb) {
	Math_Vec3F total = Math_AddVec3F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec3F(total, 0.5f);
}

AL2O3_LINK_OR_INLINE Math_Vec3F Math_HalfLengthAabb3F(Math_Aabb3F const *aabb) {
	Math_Vec3F diff = Math_SubVec3F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec3F(diff, 0.5f);
}
AL2O3_LINK_OR_INLINE void Math_SetCenterAabb3F(Math_Aabb3F *aabb, Math_Vec3F center) {
	Math_Vec3F const oldCenter = Math_CenterAabb3F(aabb);
...
AL2O3_LINK_OR_INLINE void Math_ExpandAabb3F(Math_Aabb3F *aabb, Math_Vec3F by) {
...
AL2O3_LINK_OR_INLINE bool Math_DoesIntersectAabb3F(Math_Aabb3F const *aabb, Math_Aabb3F const *with) {
	Math_Vec3F minI = Math_MaxVec3F(aabb->minExtent, with->minExtent);
	Math_Vec3F maxI = Math_MinVec3F(aabb->maxExtent, with->maxExtent);

	return ((minI.v[0] < maxI.v[0]) && (minI.v[1] < maxI.v[1]) && (minI.v[2] < maxI.v[2]));
}
AL2O3_LINK_OR_INLINE bool Math_DoesIntersectPointAabb3F(Math_Aabb3F const *aabb, Math_Vec3F const with) {
	return (
			(with.v[0] > aabb->minExtent.v[0] && with.v[0] < aabb->maxExtent.v[0]) &&
					(with.v[1] > aabb->minExtent.v[1] && with.v[1] < aabb->maxExtent.v[1]) &&
