...
AL2O3_EXTERN_C Math_Vec2F_t Math_CenterAabb2F(Math_Aabb2F const* aabb) {
	Math_Vec2F_t total = Math_AddVec2F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec2F(total, 0.5f);
}

AL2O3_EXTERN_C Math_Vec2F_t Math_HalfLengthAabb2F(Math_Aabb2F const* aabb) {
	Math_Vec2F_t diff = Math_SubVec2F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec2F(diff, 0.5f);
}
AL2O3_EXTERN_C void Math_SetCenterAabb2F(Math_Aabb2F* aabb, Math_Vec2F_t center) {
...
AL2O3_EXTERN_C bool Math_DoesIntersectPointAabb2F(Math_Aabb2F const* aabb, Math_Vec2F_t const with) {
	return(
