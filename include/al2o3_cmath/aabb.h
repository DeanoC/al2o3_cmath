...
AL2O3_EXTERN_C inline Math_Aabb2F Math_Aabb2FCreateInvalid() {
	Math_Aabb2F ret = { 0, 0, -1, -1 };
	return ret;
}

AL2O3_EXTERN_C inline Math_Aabb2F Math_Aabb2FFromCenterAndLength(Math_Vec2F_t center, Math_Vec2F_t length) {
...
AL2O3_EXTERN_C inline Math_Aabb2F Math_Aabb2FFromCenterAndHalfLength(Math_Vec2F_t center, Math_Vec2F_t halfLength) {
	Math_Aabb2F ret = {
		Math_SubVec2F(center, halfLength),
		Math_AddVec2F(center, halfLength),
	};
...
AL2O3_EXTERN_C inline bool Math_IsValidAabb2F(Math_Aabb2F const* aabb) {
	Math_Vec2F_t diff = Math_SubVec2F(aabb->maxExtent, aabb->minExtent);
	return (Math_DotVec2F(diff, diff) > 0.0f);
}

AL2O3_EXTERN_C inline Math_Vec2F_t Math_CenterAabb2F(Math_Aabb2F const* aabb) {
	Math_Vec2F_t total = Math_AddVec2F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec2F(total, 0.5f);
}

AL2O3_EXTERN_C inline Math_Vec2F_t Math_HalfLengthAabb2F(Math_Aabb2F const* aabb) {
	Math_Vec2F_t diff = Math_SubVec2F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec2F(diff, 0.5f);
}
AL2O3_EXTERN_C inline void Math_SetCenterAabb2F(Math_Aabb2F* aabb, Math_Vec2F_t center) {
...
AL2O3_EXTERN_C inline void Math_ExpandAabb2F(Math_Aabb2F* aabb, Math_Vec2F_t by) {
	aabb->minExtent = Math_MinVec2F(aabb->minExtent, by);
	aabb->maxExtent = Math_MaxVec2F(aabb->maxExtent, by);
}

AL2O3_EXTERN_C inline void Math_UnionAabb2F(Math_Aabb2F* aabb, Math_Aabb2F* with) {
	aabb->minExtent = Math_MinVec2F(aabb->minExtent, with->minExtent);
	aabb->maxExtent = Math_MaxVec2F(aabb->maxExtent, with->maxExtent);
}

AL2O3_EXTERN_C inline void Math_IntersectionAabb2F(Math_Aabb2F* aabb, Math_Aabb2F* with) {
	aabb->minExtent = Math_MaxVec2F(aabb->minExtent, with->minExtent);
	aabb->maxExtent = Math_MinVec2F(aabb->maxExtent, with->maxExtent);
}

AL2O3_EXTERN_C inline bool Math_DoesIntersectAabb2F(Math_Aabb2F const* aabb, Math_Aabb2F const* with) {
...
AL2O3_EXTERN_C inline bool Math_DoesIntersectPointAabb2F(Math_Aabb2F const* aabb, Math_Vec2F_t const with) {
	return(
		(with.v[0] > aabb->minExtent.v[0] && with.v[0] < aabb->maxExtent.v[0]) &&
		(with.v[1] > aabb->minExtent.v[1] && with.v[1] < aabb->maxExtent.v[1]));
}

AL2O3_EXTERN_C inline Math_Aabb3F Math_Aabb3FCreateInvalid() {
...
AL2O3_EXTERN_C inline Math_Vec3F_t Math_CenterAabb3F(Math_Aabb3F const* aabb) {
	Math_Vec3F_t total = Math_AddVec3F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec3F(total, 0.5f);
}

AL2O3_EXTERN_C inline Math_Vec3F_t Math_HalfLengthAabb3F(Math_Aabb3F const* aabb) {
	Math_Vec3F_t diff = Math_SubVec3F(aabb->maxExtent, aabb->minExtent);
	return Math_ScalarMulVec3F(diff, 0.5f);
}
AL2O3_EXTERN_C inline void Math_SetCenterAabb3F(Math_Aabb3F* aabb, Math_Vec3F_t center) {
...
AL2O3_EXTERN_C inline void Math_ExpandAabb3F(Math_Aabb3F* aabb, Math_Vec3F_t by) {
	aabb->minExtent = Math_MinVec3F(aabb->minExtent, by);
	aabb->maxExtent = Math_MaxVec3F(aabb->maxExtent, by);
}

AL2O3_EXTERN_C inline void Math_UnionAabb3F(Math_Aabb3F* aabb, Math_Aabb3F* with) {
	aabb->minExtent = Math_MinVec3F(aabb->minExtent, with->minExtent);
	aabb->maxExtent = Math_MaxVec3F(aabb->maxExtent, with->maxExtent);
}

AL2O3_EXTERN_C inline void Math_IntersectionAabb3F(Math_Aabb3F* aabb, Math_Aabb3F* with) {
	aabb->minExtent = Math_MaxVec3F(aabb->minExtent, with->minExtent);
	aabb->maxExtent = Math_MinVec3F(aabb->maxExtent, with->maxExtent);
}

AL2O3_EXTERN_C inline bool Math_DoesIntersectAabb3F(Math_Aabb3F const* aabb, Math_Aabb3F const* with) {
...
AL2O3_EXTERN_C inline bool Math_DoesIntersectPointAabb3F(Math_Aabb3F const* aabb, Math_Vec3F_t const with) {
	return(
		(with.v[0] > aabb->minExtent.v[0] && with.v[0] < aabb->maxExtent.v[0]) &&
		(with.v[1] > aabb->minExtent.v[1] && with.v[1] < aabb->maxExtent.v[1]) &&
