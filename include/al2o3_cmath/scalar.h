...
MATH_FM_CREATE_SIGNED(I8, int8_t)
MATH_FM_CREATE_UNSIGNED(U8, uint8_t)
MATH_FM_CREATE_SIGNED(I16, int16_t)
MATH_FM_CREATE_UNSIGNED(U16, uint16_t)
...
MATH_FM_CREATE_UNSIGNED(SizeT, size_t)
